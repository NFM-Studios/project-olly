...
class WagerRequest(models.Model):
    ...
    credits = models.PositiveIntegerField(default=5)
    game = models.ForeignKey(GameChoice, related_name='game_choices', on_delete=models.CASCADE)
    platform = models.ForeignKey(PlatformChoice, related_name='platform_choices', on_delete=models.CASCADE)
