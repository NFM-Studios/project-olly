...
class StaticInfo(models.Model):
    ...
    twitchchannel = models.URLField(verbose_name='twitch_channel', default='#')
    youtubechannel = models.URLField(verbose_name='youtube_channel', default='#')
    twitterprofile = models.URLField(verbose_name='twitter_profile', default='#')
    facebookpage = models.URLField(verbose_name='facebook_page', default='#')
    instagrampage = models.URLField(verbose_name='instagram_page', default='#')
