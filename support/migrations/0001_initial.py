        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.SmallIntegerField(
                    choices=[(0, 'General'), (1, 'Prize Claim'), (2, 'Tournament Support'), (3, 'Billing'),
                             (4, 'Refund Request'), (5, 'PSN/XBL Issues'), (6, 'Match Support/Dispute')], default=0)),
                ('text', models.TextField(default='A detailed description of your issue')),
                ('status',
                 models.SmallIntegerField(choices=[(0, 'New'), (1, 'On Hold'), (2, 'In Progress'), (3, 'Closed')],
                                          default=0)),
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_create',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments',
                                             to='support.Ticket', verbose_name='Ticket')),
            ],
            options={
