    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steam', models.CharField(blank=True, default='No Steam Linked', max_length=16)),
                ('lol', models.CharField(blank=True, default='No LOL Linked', max_length=16)),
                ('battlenet', models.CharField(blank=True, default='No Battle.net Linked', max_length=16)),
                ('twitter_profile', models.CharField(blank=True, default='No Twitter Linked', max_length=15)),
                ...
                ('country', django_countries.fields.CountryField(default='No Country Selected', max_length=2)),
