...
# Email stuff - if you decide to use gmail, you might have to disable some security settings
"""
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
FROM_EMAIL = "YOUR EMAIL <noreply@yoursite.com>"
EMAIL_PORT = 587
PAYPAL_EMAIL = "your_paypal_email@yoursite.com"
"""
# Captcha
