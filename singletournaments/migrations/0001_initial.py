# Generated by Django 2.0.1 on 2018-03-26 01:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rules', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='tournamentrules', to='matches.Ruleset')),
                ('second', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='secondplaceteam', to='teams.Team')),
                ('teams', models.ManyToManyField(blank=True, to='teams.Team')),
                ('winner', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='winningteam', to='teams.Team')),
            ],
        ),
        migrations.CreateModel(
