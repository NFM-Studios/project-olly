    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rules', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tournamentrules', to='matches.RuleSet')),
                ('second', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secondplaceteam', to='teams.Team')),
                ('teams', models.ManyToManyField(to='teams.Team')),
                ('winner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='winningteam', to='teams.Team')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='round',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teaminround', to='singletournaments.TournamentRound'),
        ),
        migrations.AddField(
            model_name='singletournamentteam',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actualteam', to='teams.Team'),
        ),
    ]
