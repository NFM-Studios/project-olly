...
def post_list(request, tag_slug=None):
    ...
    return render(request, 'news/' + request.tenant + '/news_article_list.html', {'page': page, 'posts': posts})
...
def post_detail(request, slug):
    ...
    return render(request, 'news/' + request.tenant + '/news_article_detail.html', {'post': post})
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        form = EmailPostForm()
    return render(request, 'news/' + request.tenant + 'news_share_post.html', {'post': post, 'form': form, 'sent': sent})
