...
@permission_required('matches.view_match', raise_exception=True)
...
@permission_required('matches.view_matchdispute', raise_exception=True)
...
@permission_required('matches.change_match', raise_exception=True)
...
class MatchDeclareWinner(PermissionRequiredMixin, View):
    permission_required('matches.change_match', raise_exception=True)
...
@permission_required('matches.view_gamechoice', raise_exception=True)
...
@permission_required('matches.delete_gamechoice', raise_exception=True)
...
@permission_required('matches.add_gamechoice', raise_exception=True)
...
@permission_required('matches.view_platformchoice', raise_exception=True)
...
@permission_required('matches.delete_platformchoice', raise_exception=True)
...
@permission_required('matches.add_platformchoice', raise_exception=True)
...
@permission_required('matches.delete_sportchoice', raise_exception=True)
...
@permission_required('matches.add_sportchoice', raise_exception=True)
...
@permission_required('matches.view_sportchoice', raise_exception=True)
...
@permission_required('matches.view_mapchoice', raise_exception=True)
...
@permission_required('matches.delete_mapchoice', raise_exception=True)
...
@permission_required('matches.add_mapchoice', raise_exception=True)
...
@permission_required('matches.view_mappoolchoice', raise_exception=True)
...
@permission_required('matches.delete_mappoolchoice', raise_exception=True)
...
@permission_required('matches.', raise_exception=True)
