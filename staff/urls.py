...
urlpatterns = [
    ...
    url(r'^tournaments/(?P<pk>\d+)/addteams/$', login_required(views.add_teams), name='add_team'),
    url(r'^tournaments/(?P<pk>\d+)/addteams/(?P<teamid>\d+)/$', login_required(views.add_teams), name='add_team'),
